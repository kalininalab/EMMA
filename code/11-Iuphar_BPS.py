...
enzyme_interactions = enzyme_interactions[
    ["Target UniProt ID", "Ligand PubChem SID", 'Type', 'Action', 'Affinity Units', 'Original Affinity Median nm']]
enzyme_interactions.dropna(subset=['Original Affinity Median nm', "Target UniProt ID", "Ligand PubChem SID", "Action"],
                           inplace=True)
...
enzyme_interactions["Evidence"] = "BAA"
...
enzyme_interactions.loc[enzyme_interactions['standard_type'] == "IC50", 'standard_value'] *= 0.50

enz_inh = enzyme_interactions[
    (enzyme_interactions['standard_type'].isin(["IC50", "Ki"])) &
...
enz_ni.to_pickle(join(CURRENT_DIR, "..", "data", "processed_data", "luphar", "11-luphar_enz_ni.pkl"))
