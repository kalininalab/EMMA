...
uniprot_enz_sub = pd.read_pickle(
    join(CURRENT_DIR, "..", "data", "processed_data", "uniprot", "2-1-uniprot_enz_sub.pkl"))
#######################################
# get Pubchem ID
#######################################
...
chebi_to_smiles_df = pd.read_pickle(
    join(CURRENT_DIR, "..", "data", "processed_data", "uniprot", "UniAct_chebi2smiles.pkl"))
...
# Please check the additional_code folder to see how cofactors_list.txt has been created
...
uniprot_enz_sub = uniprot_enz_sub[
