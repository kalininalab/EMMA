...
brenda_enz_inh.loc[
    (brenda_enz_inh['IC50_value'].notna()) & (brenda_enz_inh['standard_type'].isna()), 'standard_type'] = 'IC50'
...
brenda_enz_inh_kiic["Evidence"] = "BAA"  # DBA stands for Direct Binding Assay
