...
chembl_binding_activities = pd.read_pickle(join(CURRENT_DIR, "..", "data", "processed_data", "chembl",  "6-3-chembl_binding_activities.pkl"))
...
chembl_sequence_df = pd.read_pickle(join(CURRENT_DIR, "..", "data", "processed_data","chembl", "chembl_ProId2seq_v2.pkl"))
...
chembl_binding_activities.to_pickle(join(CURRENT_DIR, "..", "data", "processed_data", "chembl",  "6-4-chembl_binding_activities.pkl"))
